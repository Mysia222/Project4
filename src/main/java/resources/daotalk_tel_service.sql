...
--
-- Dumping data for table `tel_service`
--

LOCK TABLES `tel_service` WRITE;
/*!40000 ALTER TABLE `tel_service` DISABLE KEYS */;
INSERT INTO `tel_service` VALUES (1,'3g',50),(2,'3g+',55);
/*!40000 ALTER TABLE `tel_service` ENABLE KEYS */;
UNLOCK TABLES;
